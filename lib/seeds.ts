import { SeedType, SeedConfig } from "./types";
...
export const getCropDisplay = (crop: any): string => {
  ...
  if (crop.stage === 0) {
    if (crop.wateringsReceived > 0 && crop.wateringsReceived < config.wateringsRequired) {
      return "💧";
    }
  }
